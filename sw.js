...
const CORE = [
  ...
  './js/_ns.js', './js/random.js', './js/util.js', './js/core.js', './js/icons.js', './js/sound.js', './js/spin.js', './js/multi.js', './js/wheels.js', './js/growth.js', './js/navigation.js', './js/chart.js' './js/state.js'
  './转盘/_index.js',
